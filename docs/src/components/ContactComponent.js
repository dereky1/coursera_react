...
class Contact extends Component {
  ...
  validate(firstname, lastname, telnum, email){
    ...
    if(this.state.touched.telnum && !reg.test(telnum))
      errors.telnum = 'Telephone Num should only contain numbers';
            ...
            <div className="col-12 col-md-9">
              <Form onSubmit={this.handleSubmit}>
                ...
                <FormGroup row>
                  ...
                  <Col md={10}>
                    <Input type="text" id="telnum" name="telnum" placeholder="Tel. Number" value={this.state.telnum} onChange={this.handleInputChange} onBlur={this.handleBlur('telnum')} valid={errors.telnum === ''} invalid={errors.telnum !== ''}/>
